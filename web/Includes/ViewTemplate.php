<?php
function viewTemplate($name,$email,$phone_number,$placement,$coverup){
    $viewBody =
        '
<tr>
...
<td id="m_7528236957803100486value_14" class="m_7528236957803100486valueColumn" style="padding:12px 0;color:#0a1551;font-weight:500" width="70%" valign="top">';
return $viewBody;
}
?>

<?php
function viewTemplate2($tattoo_size,$style,$color,$description,$font){
    $viewBody2 =
    '
</td>
</tr>
...
<td id="m_7528236957803100486value_21" class="m_7528236957803100486valueColumn" style="padding:12px 0;color:#0a1551;font-weight:500" width="70%" valign="top">';
return $viewBody2;
}
?>
...
<td id="m_7528236957803100486value_22" class="m_7528236957803100486valueColumn" style="padding:12px 0;color:#0a1551;font-weight:500" width="70%" valign="top">
';
return $viewBody3;
}
?>
...
<td id="m_7528236957803100486value_23" class="m_7528236957803100486valueColumn" style="padding:12px 0;color:#0a1551;font-weight:500" width="70%" valign="top">
';
    return $viewBody4;
}
?>
...
<?php
function viewTemplate5($preferred_days,$preferred_time,$specific_date,$comments,$previous_client){
    $viewBody5 =
    '
</td>
</tr>
